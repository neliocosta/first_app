    ...
    grupos: [
      ...
      },
      {
        titulo: 'Valor e venda', campos: [
          { chave: 'emp.valorEstimado', rotulo: 'Você tem uma ideia de quanto vale a empresa hoje?', tipo: TIPO.MOEDA,
            sugeridoPor: 'CFP + Cliente', permiteEmBranco: true,
            ajuda: 'Se o cliente não souber, deixe em branco — a consultoria não avalia empresa e não estima por ele' },
          { chave: 'emp.baseAvaliacao', rotulo: 'De onde vem esse valor?', tipo: TIPO.SELECAO,
            opcoes: ['Laudo de avaliação', 'Múltiplo de faturamento', 'Proposta recebida', 'Estimativa do próprio cliente'],
            sugeridoPor: 'CFP + Cliente', permiteEmBranco: true,
            revelaSe: { campo: 'emp.valorEstimado', preenchido: true },
            ajuda: 'Dá proveniência ao número. Em branco = o plano trata a empresa como valor não estimado, nunca como zero' },
    ...
    grupos: [
      {
        titulo: 'Base legal da sucessão', campos: [
          ...
          { chave: 'suc.ufDomicilio', rotulo: 'Em qual estado você mora?', tipo: TIPO.SELECAO, sugeridoPor: 'CFP',
            opcoes: ['SP', 'RJ', 'MG', 'RS', 'PR', 'SC', 'BA', 'PE', 'CE', 'GO', 'DF', 'Outra'],
            ajuda: 'Só o dado do cliente. A alíquota de ITCMD desse estado é levantada pelo consultor na Montagem do Relatório — não é pergunta de reunião' },
        ],
      },
      {
